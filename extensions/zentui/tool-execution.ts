...
export function installToolExecutionStyle(
	...
	let cleanupInvalidatePatch: Cleanup | undefined;
	let cleanupBashRender: Cleanup | undefined;
	try {
		cleanupInvalidatePatch = installPrototypePatch(
			ToolExecutionComponent.prototype,
			"invalidate",
		...
		cleanupBashRender = installPrototypePatch(
